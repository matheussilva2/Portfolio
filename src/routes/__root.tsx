...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio de Matheus Silva" },
      { name: "author", content: "Matheus Silva" },
      { property: "og:title", content: "Matheus Silva — Portfolio" },
      { property: "og:description", content: "Portfolio de Matheus Silva" },
